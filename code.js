...
function search(){
    ...
    alert(roomnum[0] + "階は存在しません。");
        ...
        if (typeof data[roomnum] == "undefined"){
            ...
            document.getElementById("map").src = "map.html#" + roomnum;
            /*
            // changing floor
            ...
            h1.style.left = data[roomnum][0] * map_scale + parseFloat(wnx) + "px";
            h1.style.top = data[roomnum][1] * map_scale + parseFloat(wny) + "px";
            h1.style.zIndex = 1;
            h1.style.visibility = "visible";
